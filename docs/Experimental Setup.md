...
1. Clone the library's repository (can be found by searching the [Maven Repository](https://mvnrepository.com)) using
   `git clone`.
...
4. Open the project inside IntelliJ.
   1. From the welcome menu, press **Open** and select the project folder.
   2. Go to menu bar item **File** > **Open...** and select the project folder.
   
   <img src="../images/open_project.png" alt="Open folder in IntelliJ" width="400">
